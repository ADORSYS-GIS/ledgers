...
public class ModelbankFinalizeAuthenticatorFactory implements AuthenticatorFactory, ServerInfoAwareProviderFactory {

    @Override
    public String getId() {
        return "finalized-authenticator";
    }
    ...
    public String getDisplayType() {
        return "Modelbank authorization finalization";
    }

    @Override
    public String getHelpText() {
        return "Shows the final step of authorization.";
    }
    ...
    public Authenticator create(KeycloakSession session) {
        return new ModelbankFinalizeAuthenticator(session);
    }
