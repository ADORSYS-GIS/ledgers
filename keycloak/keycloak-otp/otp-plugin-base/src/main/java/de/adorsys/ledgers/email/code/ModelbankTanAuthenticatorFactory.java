...
public class ModelbankTanAuthenticatorFactory implements AuthenticatorFactory, ServerInfoAwareProviderFactory {

    @Override
    public String getId() {
        return "tan-authenticator";
    }
    ...
    public String getDisplayType() {
        return "Modelbank TAN";
    }

    @Override
    public String getHelpText() {
        return "Shows TAN sent to the user.";
    }
    ...
    public Authenticator create(KeycloakSession session) {
        return new ModelbankTanAuthenticator(session);
    }
