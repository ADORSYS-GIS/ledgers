...
public class OperationStage extends BaseStage<OperationStage> {
    ...
    public static final String SCA_AUTHORISATIONS = "/sca/authorisations/{authorisationId}";
    public static final String SCA_AUTHORISATION_VALUE = "/sca/authorisations/{authorisationId}/authCode";
